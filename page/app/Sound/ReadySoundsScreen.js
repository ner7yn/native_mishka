...
const styles = StyleSheet.create({
    ...
    card: {
        ...
        width: width * 0.90, // 95% of the screen width
        height: height * 0.22, // 23% of the screen height
        marginBottom: '4%',
        borderRadius: 15,
        paddingTop: '5%',
        paddingLeft: '6%',
    ...
    cardPressed: {
        backgroundColor: '#608c2f', // Change this to the color you want when pressed
    },
    cardText: {
